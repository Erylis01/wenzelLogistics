                            ...
                            <table class="table table-hover table-bordered table-loadings">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">ID<a class="glyphicon glyphicon-chevron-up loadings-sorting"
                                                ...
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=id&order=desc')}}"></a>
                                    </th>
                                    ...
                                    <th class="text-center">Referenz <a
                                                class="glyphicon glyphicon-chevron-up loadings-sorting"
                                    ...
                                    <th class="text-center">Anzahl <a
                                                ...
                                                class="glyphicon glyphicon-chevron-down loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=anzahl&order=desc')}}"></a>
                                    </th>
                                    <th class="text-center">TRY1<a
                                                class="glyphicon glyphicon-chevron-up loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=try1&order=asc')}}"></a><a
                                                class="glyphicon glyphicon-chevron-down loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=try1&order=desc')}}"></a>
                                    </th>
                                    <th class="text-center">TRY2<a
                                                class="glyphicon glyphicon-chevron-up loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=try2&order=asc')}}"></a><a
                                                class="glyphicon glyphicon-chevron-down loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=try2&order=desc')}}"></a>
                                    </th>
                                    <th class="text-center">TRY3<a
                                                class="glyphicon glyphicon-chevron-up loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=try3&order=asc')}}"></a><a
                                                class="glyphicon glyphicon-chevron-down loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=try3&order=desc')}}"></a>
                                    </th>
                                    ...
                                    <th class="text-center">Pal<a
                                                class="glyphicon glyphicon-chevron-up loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=pal&order=asc')}}"></a><a
                                                class="glyphicon glyphicon-chevron-down loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=pal&order=desc')}}"></a>
                                    </th>
                                    <th class="text-center">Im Klärung<a
                                                class="glyphicon glyphicon-chevron-up loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=imklarung&order=asc')}}"></a><a
                                                class="glyphicon glyphicon-chevron-down loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=imklarung&order=desc')}}"></a>
                                    </th>
                                    <th class="text-center">Pal Tausch Vereinbart ? <a
                                                class="glyphicon glyphicon-chevron-up loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=paltauschvereinbart&order=asc')}}"></a><a
                                                class="glyphicon glyphicon-chevron-down loadings-sorting"
                                                href="{{url('/loadings?page='.$listLoadings->currentPage().'&sortby=paltauschvereinbart&order=desc')}}"></a>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($listLoadings as $loading)
                                    ...
                                    @endif
                                    <tr class={{$class}}>
                                        <td><a href="{{route('showDetailsLoading',$loading->id)}}">{{$loading->id}}</a>
                                        </td>
