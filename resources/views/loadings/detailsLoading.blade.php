                                    ...
                                    @else
                                        <div id="Pan2collapse" class="panel-collapse collapse">
                                            ...
                                            <div class="panel-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col-lg-5">
                                                                                    <label for="numberPalletsBackLoadingPlace"
                                                                                        ...
                                                                                        many pallets do we brought back
                                                                                        ?</label>
                                                                                </div>
                                                                                <div class="col-lg-2">
                                                                                    @if(isset($numberPalletsBackLoadingPlace))
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col-lg-5">
                                                                                    <label for="documentsLoading"
                                                                                           class="control-label">Do you
                                                                                        have proof documents (CMR/exchange) ?</label>
                                                                                </div>
                                                                                <div class="col-lg-2">
                                                                                    <input type="file"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col-lg-5">
                                                                                    <label for="accountLoadingPlace"
                                                                                        ...
                                                                                        account is concerned ?</label>
                                                                                </div>
                                                                                <div class="col-lg-6">
                                                                                    {{--@foreach($listPalletsAccounts as $palletsAccount )--}}
                                                                                        {{--@if(isset($accountLoadingPlace)&& $palletsAccount->name==$accountLoadingPlace)--}}
                                                                                            {{--@php(dd($accountLoadingPlace))--}}
                                                                                           {{--@endif --}}
                                                                                {{--@endforeach--}}
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="col-lg-5">
                                                                                        <label for="validateLoadingPlace"
                                                                                            ...
                                                                                            this transfer validated
                                                                                            ?</label>
                                                                                    </div>
                                                                                    <div class="col-lg-3">
                                                                                        @if($validateLoadingPlace==true)
                                                                                            <label class="radio-inline"><input type="radio" name="validateLoadingPlace" value="true" checked>Yes</label>
                                                                                            <label class="radio-inline"><input type="radio" name="validateLoadingPlace" value="false" >No</label>
                                                                                        @else
                                                                                            <label class="radio-inline"><input type="radio" name="validateLoadingPlace" value="true">Yes</label>
                                                                                            <label class="radio-inline"><input type="radio" name="validateLoadingPlace" value="false" checked>No</label>
                                                                                            @endif
                                                                                    </div>
                                                                                </div>
                                                                            @endif
                                                ...
                                                <div class="panel subpanel">
                                                    <div class="panel-heading">
                                                        <a data-toggle="collapse" href="#Pan2Sub2collapse">Unloading
                                                            place</a>
                                                    </div>
                                                ...
                                                <div class="panel subpanel">
                                                    <div class="panel-heading">
                                                        <a data-toggle="collapse" href="#Pan2Sub4collapse">Other
                                                            place</a>
                                                    </div>
