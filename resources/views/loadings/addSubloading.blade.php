                ...
                <div class="panel panel-general">
                    ...
                    <div class="panel-body panel-body-general">
                        <form class="form-horizontal"
                              role="form"
                              method="POST"
                              action="{{route('addSubloading', $loading->atrnr)}}">
                            <input type="hidden"
                                   name="_token"
                                   value="{{ csrf_token() }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3 details-loading">
                                    <label for="kennzeichen"
                                           class="control-label">Kennzeichen
                                        :</label>
                                    <input type="text"
                                           name="kennzeichen"
                                           class="form-control"
