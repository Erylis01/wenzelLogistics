                    ...
                    <div class="table-responsive table-big-warehouses">
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                @foreach($warehousesName as $name)
                            ...
                            <tr>
                                ...
                                <td class="text-center colTotal">{{$totalpalanzahl}}</td>
                                @foreach($warehousesPalAnzahl as $palAnzahl)
                                    <td class="text-center colFakturiert">{{$palAnzahl}}</td>
                                @endforeach
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="panel-body panel-body-general">
                        ...
                        <div class="table-responsive table-big-warehouses">
                            <table class="table table-hover table-bordered">
                                ...
                                <tr>
                                    <td class="text-center colIDLoading">ID Loading</td>
                                    <td class="text-center {{$size}}">Anzahl pal</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
