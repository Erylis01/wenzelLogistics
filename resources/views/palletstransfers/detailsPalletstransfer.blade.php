                                                ...
                                                <form class="form-horizontal text-right" role="form" method="POST"
                                                    ...
                                                    <div class="panel-body panel-body-general">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        @elseif(isset($transfer->type))
                                                                            ...
                                                                            <optgroup label="Correcting">
                                                                                ...
                                                                                <option @if($transfer->type == 'Purchase-Sale') selected
                                                                                        @endif value="Purchase-Sale"
                                                                                        id="Purchase-SaleOption">
                                                                                    Purchase_Int
                                                                                </option>
                                                                                ...
                                                                                <option @if($transfer->type == 'Sale-Purchase') selected
                                                                                        @endif value="Sale-Purchase"
                                                                                        id="Sale-PurchaseOption">
                                                                                    Sale_Int
                                                                                </option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            @if($transfer->type=='Purchase-Sale' || $transfer->type=='Sale-Purchase' || $transfer->type == 'Other')
                                                                ...
                                                                <div class="form-group">
                                                                    <!--debit account-->
                                                                    @if($transfer->type=='Other'||$transfer->type=='Purchase-Sale'||$transfer->type=='Sale_Ext'||$transfer->type=='Sale-Purchase'||$transfer->type=='Deposit-Withdrawal'||$transfer->type=='Withdrawal-Deposit'||$transfer->type=='Deposit_Only'||$transfer->type=='Withdrawal_Only')
                                                                ...
                                                                <!--credit account-->
                                                                    @if($transfer->type=='Other'||$transfer->type=='Purchase-Sale'||$transfer->type=='Purchase_Ext'||$transfer->type=='Sale-Purchase'||$transfer->type=='Deposit-Withdrawal'||$transfer->type=='Withdrawal-Deposit'||$transfer->type=='Deposit_Only'||$transfer->type=='Withdrawal_Only')
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-lg-2">
                                                                        <label for="documentsTransfer"><span>*</span>
                                                                            Proof
                                                                            docs
                                                                            ?</label>
                                                                    </div>
