...
class Loading extends Model
{
    protected $fillable = [
        ...
        'numberPalletsLoadingPlace1', 'accountCreditLoadingPlace1','accountDebitLoadingPlace1','stateLoadingPlace1', 'validateLoadingPlace1','countTimeLoadingPlace1',
        'numberPalletsOffloadingPlace1', 'accountCreditOffloadingPlace1','accountDebitOffloadingPlace1','stateOffloadingPlace1', 'validateOffloadingPlace1','countTimeOffloadingPlace1',
    'numberPalletsLoadingPlace2', 'accountCreditLoadingPlace2','accountDebitLoadingPlace2','stateLoadingPlace2', 'validateLoadingPlace2','countTimeLoadingPlace2',
        'numberPalletsOffloadingPlace2', 'accountCreditOffloadingPlace2','accountDebitOffloadingPlace2','stateOffloadingPlace2', 'validateOffloadingPlace2','countTimeOffloadingPlace2',
    'numberPalletsLoadingPlace3', 'accountCreditLoadingPlace3','accountDebitLoadingPlace3','stateLoadingPlace3', 'validateLoadingPlace3','countTimeLoadingPlace3',
        'numberPalletsOffloadingPlace3', 'accountCreditOffloadingPlace3','accountDebitOffloadingPlace3','stateOffloadingPlace3', 'validateOffloadingPlace3','countTimeOffloadingPlace3',
